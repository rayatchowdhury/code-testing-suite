...
class TestBasicValidation:
    ...
    def test_basic_validation_workflow(self, cpp_validator_workspace, qtbot):
        ...
        def on_test_completed(test_num, passed, input_data, test_output, 
                            validation_message, error_details, validator_exit_code, exec_time, memory):
...
class TestParallelExecution:
    ...
    def test_parallel_execution(self, cpp_validator_workspace, qtbot):
        ...
        assert total_time < 15.0, f"Parallel execution should complete quickly (took {total_time:.2f}s)"
