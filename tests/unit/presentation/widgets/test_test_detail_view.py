...
class TestComparatorDetailDialog:
    ...
    def test_displays_expected_output_section(self, qtbot):
        ...
        expected_found = any("3" in edit.toPlainText() and edit.toPlainText().strip() == "3" 
    ...
    def test_displays_actual_output_section(self, qtbot):
        ...
        actual_found = any("5" in edit.toPlainText() and edit.toPlainText().strip() == "5" 
                          for edit in text_edits)
        assert actual_found
...
class TestValidatorDetailDialog:
    ...
    def test_displays_validator_log_for_passed_test(self, qtbot):
        ...
        log_found = any("Valid output" in edit.toPlainText() or "correct" in edit.toPlainText().lower()
                       for edit in text_edits)
        assert log_found
    ...
    def test_displays_validator_log_for_wrong_answer(self, qtbot):
        ...
        error_found = any("Wrong Answer" in edit.toPlainText() or 
                         "Expected 5, got 3" in edit.toPlainText()
                         for edit in text_edits)
        assert error_found
    ...
    def test_interprets_exit_code_1_as_wrong_answer(self, qtbot):
        ...
        code_found = any("Exit Code: 1" in edit.toPlainText() or 
    ...
    def test_interprets_exit_code_2_as_presentation_error(self, qtbot):
        ...
        code_found = any("Exit Code: 2" in edit.toPlainText() or 
                        "Presentation Error" in edit.toPlainText()
                        for edit in text_edits)
        assert code_found
...
class TestBenchmarkerDetailDialog:
    ...
    def test_displays_performance_summary(self, qtbot):
        ...
        summary_found = any("Performance" in edit.toPlainText() or 
                           "Input Lines" in edit.toPlainText()
                           for edit in text_edits)
...
class TestDetailDialogCommonFeatures:
    ...
    def test_all_dialogs_have_metrics_display(self, qtbot):
        ...
        for dialog in dialogs:
            ...
            has_time = any("0.1" in label.text() or "Time" in label.text() 
                          for label in labels)
            has_memory = any("32" in label.text() or "Memory" in label.text() 
                            for label in labels)
