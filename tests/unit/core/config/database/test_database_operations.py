...
class TestCleanupOldData:
    ...
    def test_cleanup_executes(self, mock_question, mock_info, db_operations, mock_database_manager):
        ...
        mock_database_manager.get_database_stats.side_effect = [
            {'test_results_count': 1000, 'sessions_count': 50, 'database_size_mb': 25.5,
             'oldest_test': '2024-01-01', 'newest_test': '2024-12-31',
             'oldest_session': '2024-01-15', 'newest_session': '2024-12-20'},
            {'test_results_count': 800, 'sessions_count': 40, 'database_size_mb': 20.0,
             'oldest_test': '2024-06-01', 'newest_test': '2024-12-31',
             'oldest_session': '2024-06-15', 'newest_session': '2024-12-20'},
            {'test_results_count': 800, 'sessions_count': 40, 'database_size_mb': 20.0,
             'oldest_test': '2024-06-01', 'newest_test': '2024-12-31',
             'oldest_session': '2024-06-15', 'newest_session': '2024-12-20'},
        ]
...
class TestDeleteAllData:
    ...
    @patch('src.app.core.config.database.database_operations.QMessageBox.information')
    @patch('src.app.core.config.database.database_operations.QMessageBox.warning')
    def test_wrong_confirmation_text(self, mock_warning, mock_info, mock_input, db_operations, mock_database_manager):
    ...
    @patch('src.app.core.config.database.database_operations.QMessageBox.information')
    @patch('src.app.core.config.database.database_operations.QMessageBox.warning')
    def test_successful_delete(self, mock_warning, mock_info, mock_input, db_operations, mock_database_manager):
        ...
        mock_database_manager.get_database_stats.side_effect = [
            {'test_results_count': 1000, 'sessions_count': 50, 'database_size_mb': 25.5,
             'oldest_test': '2024-01-01', 'newest_test': '2024-12-31',
             'oldest_session': '2024-01-15', 'newest_session': '2024-12-20'},
            {'test_results_count': 0, 'sessions_count': 0, 'database_size_mb': 0.0,
             'oldest_test': 'N/A', 'newest_test': 'N/A',
             'oldest_session': 'N/A', 'newest_session': 'N/A'},
        ]
...
class TestOptimizeDatabase:
    ...
    @patch('src.app.core.config.database.database_operations.QMessageBox.information')
    @patch('src.app.core.config.database.database_operations.QMessageBox.question')
    def test_successful_optimization(self, mock_question, mock_info, db_operations, mock_database_manager):
        ...
        mock_database_manager.get_database_stats.side_effect = [
            {'test_results_count': 1000, 'sessions_count': 50, 'database_size_mb': 25.5,
             'oldest_test': '2024-01-01', 'newest_test': '2024-12-31',
             'oldest_session': '2024-01-15', 'newest_session': '2024-12-20'},
            {'test_results_count': 1000, 'sessions_count': 50, 'database_size_mb': 20.3,
             'oldest_test': '2024-01-01', 'newest_test': '2024-12-31',
             'oldest_session': '2024-01-15', 'newest_session': '2024-12-20'},
        ]
    ...
    @patch('src.app.core.config.database.database_operations.QMessageBox.information')
    @patch('src.app.core.config.database.database_operations.QMessageBox.question')
    def test_already_optimized(self, mock_question, mock_info, db_operations, mock_database_manager):
        ...
        mock_database_manager.get_database_stats.side_effect = [
            {'test_results_count': 1000, 'sessions_count': 50, 'database_size_mb': 20.3,
             'oldest_test': '2024-01-01', 'newest_test': '2024-12-31',
             'oldest_session': '2024-01-15', 'newest_session': '2024-12-20'},
            {'test_results_count': 1000, 'sessions_count': 50, 'database_size_mb': 20.295,
             'oldest_test': '2024-01-01', 'newest_test': '2024-12-31',
             'oldest_session': '2024-01-15', 'newest_session': '2024-12-20'},
        ]
...
class TestIntegration:
    ...
    def test_refresh_called_after_cleanup(self, db_operations, mock_parent_dialog):
        ...
        with patch('src.app.core.config.database.database_operations.QMessageBox.information'):
            with patch('src.app.core.config.database.database_operations.QMessageBox.question', return_value=QMessageBox.Yes):
                db_operations.cleanup_old_data()
