...
class TestConfigManagerLoad:
    ...
    def test_load_missing_required_keys_raises_validation_error(self, config_manager, temp_config_file):
    ...
    @patch('os.access')
    def test_load_no_read_permission_raises_permission_error(self, mock_access, config_manager, temp_config_file):
...
class TestConfigManagerValidation:
    ...
    def test_validate_missing_cpp_version(self, config_manager):
        ...
        config = {
            ...
            'editor_settings': {'autosave': True, 'autosave_interval': 5, 'tab_width': 4, 'font_size': 12, 'bracket_matching': True}
        }
...
class TestConfigPersistence:
    ...
    def test_load_config_populates_ui(self, mock_parent_dialog, config_manager, temp_config_file, valid_config):
    ...
    def test_load_config_invalid_uses_default(self, mock_parent_dialog, config_manager, temp_config_file):
    ...
    def test_load_config_with_api_key_enables_checkbox(self, mock_parent_dialog, config_manager, temp_config_file, valid_config):
    ...
    def test_load_config_without_api_key_disables_checkbox(self, mock_parent_dialog, config_manager, temp_config_file, valid_config):
    ...
    def test_load_config_populates_language_flags(self, mock_parent_dialog, config_manager, temp_config_file, valid_config):
        ...
        valid_config['languages']['py'] = {'interpreter': 'python', 'flags': ['-u', '-B']}
...
class TestIntegration:
    ...
    def test_config_persistence_workflow(self, mock_parent_dialog, config_manager, temp_config_file, valid_config):
