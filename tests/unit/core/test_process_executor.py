...
class TestRunWithTempFiles:
    ...
    def test_run_with_input_file(self):
        ...
        result, input_file, output_file = ProcessExecutor.run_with_temp_files(
            command=['python', '-c', 'import sys; print(open(sys.argv[1]).read())', '{input_file}'],
...
class TestRunPipeline:
    ...
    def test_three_stage_pipeline(self):
        ...
        stages = [
            ...
            {
                'command': ['python', '-c', 'import sys; print(int(sys.stdin.read()) * 2)'],
            },
            {
                'command': ['python', '-c', 'import sys; print(int(sys.stdin.read()) + 10)'],
            }
        ]
    ...
    def test_pipeline_with_memory_monitoring(self):
        ...
        stages = [
            {
                'command': ['python', '-c', 'x = [i for i in range(100)]; print("done")'],
                'input': '',
                'monitor_memory': True
            }
        ]
