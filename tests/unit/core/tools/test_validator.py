...
class TestValidatorInitialization:
    ...
    def test_init_with_default_files(self, temp_workspace, mock_compiler, mock_database):
        ...
        with patch('src.app.shared.constants.paths.get_workspace_file_path') as mock_path:
            mock_path.side_effect = lambda workspace, test_type, filename: f'{workspace}/{test_type}/{filename}'
    ...
    def test_init_with_custom_files(self, temp_workspace, validator_files, mock_compiler, mock_database):
    ...
    def test_init_inherits_from_base_runner(self, temp_workspace, validator_files, mock_compiler, mock_database):
    ...
    def test_init_defines_test_completed_signal(self, temp_workspace, validator_files, mock_compiler, mock_database):
...
class TestValidatorWorkerCreation:
    ...
    def test_create_test_worker_returns_validator_worker(self, mock_worker_class, temp_workspace, validator_files, mock_compiler, mock_database):
    ...
    @patch('src.app.core.tools.validator.ValidatorTestWorker')
    def test_create_test_worker_includes_execution_commands(self, mock_worker_class, temp_workspace, validator_files, mock_compiler, mock_database):
    ...
    @patch('src.app.core.tools.validator.ValidatorTestWorker')
    def test_create_test_worker_with_default_max_workers(self, mock_worker_class, temp_workspace, validator_files, mock_compiler, mock_database):
...
class TestValidatorSignalConnections:
    ...
    def test_connect_worker_signals_connects_test_completed(self, temp_workspace, validator_files, mock_compiler, mock_database):
    ...
    def test_connect_worker_signals_calls_parent(self, temp_workspace, validator_files, mock_compiler, mock_database):
    ...
    def test_connect_worker_signals_handles_missing_signal(self, temp_workspace, validator_files, mock_compiler, mock_database):
...
class TestValidatorResultCreation:
    ...
    def test_create_test_result_returns_test_result_object(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should create TestResult object with validation data."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        validator.test_count = 2  # Set test_count for analysis
        
        test_results = [
            {'test_number': 1, 'passed': True, 'validator_exit_code': 0, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.15},
            {'test_number': 2, 'passed': False, 'validator_exit_code': 1, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.15}
        ]
    ...
    def test_create_test_result_includes_validation_summary(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should include detailed validation exit code summary."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        validator.test_count = 6  # Set test_count for analysis
        
        test_results = [
            {'test_number': 1, 'validator_exit_code': 0, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1},  # Correct
            {'test_number': 2, 'validator_exit_code': 1, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1},  # Wrong Answer
            {'test_number': 3, 'validator_exit_code': 2, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1},  # Presentation Error
            {'test_number': 4, 'validator_exit_code': 5, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1},  # Validator Error
            {'test_number': 5, 'validator_exit_code': -2, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0},  # Timeout
            {'test_number': 6, 'validator_exit_code': -3, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0}   # System Error
        ]
    ...
    def test_create_test_result_calculates_execution_times(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should calculate average execution times for validator workflow."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        validator.test_count = 2  # Set test_count for analysis
        
        test_results = [
            {'test_number': 1, 'passed': True, 'validator_exit_code': 0, 'generator_time': 0.1, 'test_time': 0.3, 'validator_time': 0.2},
            {'test_number': 2, 'passed': True, 'validator_exit_code': 0, 'generator_time': 0.2, 'test_time': 0.4, 'validator_time': 0.3}
        ]
    ...
    def test_create_test_result_includes_failed_tests(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should include details of failed tests."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        
        test_results = [
            {'test_number': 1, 'passed': True, 'validator_exit_code': 0, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.15},
            {'test_number': 2, 'passed': False, 'validator_exit_code': 1, 'error_details': 'Wrong Answer', 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.15}
        ]
    ...
    def test_create_test_result_creates_files_snapshot(self, temp_workspace, validator_files, mock_compiler, mock_database):
...
class TestValidatorPublicAPI:
    ...
    def test_run_validation_test_calls_base_run_tests(self, temp_workspace, validator_files, mock_compiler, mock_database):
    ...
    def test_run_validation_test_with_default_max_workers(self, temp_workspace, validator_files, mock_compiler, mock_database):
    ...
    def test_run_validation_test_maintains_api_compatibility(self, temp_workspace, validator_files, mock_compiler, mock_database):
...
class TestValidatorExitCodes:
    ...
    def test_exit_code_0_correct_output(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should recognize exit code 0 as correct output."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        
        test_results = [
            {'test_number': 1, 'validator_exit_code': 0, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1}
        ]
    ...
    def test_exit_code_1_wrong_answer(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should recognize exit code 1 as wrong answer."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        
        test_results = [
            {'test_number': 1, 'validator_exit_code': 1, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1}
        ]
    ...
    def test_exit_code_2_presentation_error(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should recognize exit code 2 as presentation error."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        
        test_results = [
            {'test_number': 1, 'validator_exit_code': 2, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1}
        ]
    ...
    def test_exit_code_high_validator_error(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should recognize exit codes > 2 as validator errors."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        
        test_results = [
            {'test_number': 1, 'validator_exit_code': 3, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1},
            {'test_number': 2, 'validator_exit_code': 5, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1}
        ]
    ...
    def test_exit_code_negative_2_timeout(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should recognize exit code -2 as timeout."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        
        test_results = [
            {'test_number': 1, 'validator_exit_code': -2, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0}
        ]
    ...
    def test_exit_code_negative_3_system_error(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should recognize exit code -3 as system error."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        
        test_results = [
            {'test_number': 1, 'validator_exit_code': -3, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0}
        ]
...
class TestValidatorEdgeCases:
    ...
    def test_create_test_result_with_empty_results(self, temp_workspace, validator_files, mock_compiler, mock_database):
    ...
    def test_create_test_result_with_all_failures(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should handle all tests failing."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        
        test_results = [
            {'test_number': 1, 'passed': False, 'validator_exit_code': 1, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.15},
            {'test_number': 2, 'passed': False, 'validator_exit_code': 2, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.15}
        ]
    ...
    def test_create_test_result_with_mixed_exit_codes(self, temp_workspace, validator_files, mock_compiler, mock_database):
        """Should correctly categorize mixed validator exit codes."""
        validator = ValidatorRunner(str(temp_workspace), files=validator_files)
        
        test_results = [
            {'test_number': 1, 'validator_exit_code': 0, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1},
            {'test_number': 2, 'validator_exit_code': 1, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1},
            {'test_number': 3, 'validator_exit_code': 2, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1},
            {'test_number': 4, 'validator_exit_code': 0, 'generator_time': 0.1, 'test_time': 0.2, 'validator_time': 0.1}
        ]
