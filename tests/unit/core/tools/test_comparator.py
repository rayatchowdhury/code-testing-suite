...
class TestComparatorInitialization:
    ...
    def test_init_with_custom_files(self, temp_workspace, comparator_files, mock_compiler, mock_database):
    ...
    def test_init_inherits_from_base_runner(self, temp_workspace, comparator_files, mock_compiler, mock_database):
    ...
    def test_init_defines_test_completed_signal(self, temp_workspace, comparator_files, mock_compiler, mock_database):
...
class TestComparatorCompilerFlags:
    ...
    def test_get_compiler_flags_returns_optimization_flags(self, temp_workspace, comparator_files, mock_compiler, mock_database):
    ...
    def test_get_compiler_flags_order_and_completeness(self, temp_workspace, comparator_files, mock_compiler, mock_database):
        """Should return all required flags in correct order."""
        comparator = Comparator(str(temp_workspace), files=comparator_files)
        
        flags = comparator._get_compiler_flags()
        
        expected_flags = ['-O2', '-march=native', '-mtune=native', '-pipe', '-std=c++17', '-Wall']
...
class TestComparatorWorkerCreation:
    ...
    def test_create_test_worker_returns_comparison_worker(self, mock_worker_class, temp_workspace, comparator_files, mock_compiler, mock_database):
    ...
    @patch('src.app.core.tools.comparator.ComparisonTestWorker')
    def test_create_test_worker_includes_execution_commands(self, mock_worker_class, temp_workspace, comparator_files, mock_compiler, mock_database):
    ...
    @patch('src.app.core.tools.comparator.ComparisonTestWorker')
    def test_create_test_worker_with_default_max_workers(self, mock_worker_class, temp_workspace, comparator_files, mock_compiler, mock_database):
...
class TestComparatorSignalConnections:
    ...
    def test_connect_worker_signals_connects_test_completed(self, temp_workspace, comparator_files, mock_compiler, mock_database):
    ...
    def test_connect_worker_signals_calls_parent(self, temp_workspace, comparator_files, mock_compiler, mock_database):
    ...
    def test_connect_worker_signals_handles_missing_signal(self, temp_workspace, comparator_files, mock_compiler, mock_database):
...
class TestComparatorResultCreation:
    ...
    def test_create_test_result_returns_test_result_object(self, temp_workspace, comparator_files, mock_compiler, mock_database):
        """Should create TestResult object with comparison data."""
        comparator = Comparator(str(temp_workspace), files=comparator_files)
        comparator.test_count = 2  # Set test_count for analysis
        
        test_results = [
            {'test_number': 1, 'passed': True, 'generator_time': 0.1, 'test_time': 0.2, 'correct_time': 0.15, 'comparison_time': 0.05},
            {'test_number': 2, 'passed': False, 'error_details': 'Output mismatch', 'generator_time': 0.1, 'test_time': 0.2, 'correct_time': 0.15, 'comparison_time': 0.05}
        ]
    ...
    def test_create_test_result_includes_comparison_summary(self, temp_workspace, comparator_files, mock_compiler, mock_database):
        ...
        test_results = [
            {'test_number': 1, 'passed': True, 'generator_time': 0.1, 'test_time': 0.2, 'correct_time': 0.15, 'comparison_time': 0.05},
            {'test_number': 2, 'passed': False, 'generator_time': 0.1, 'test_time': 0.2, 'correct_time': 0.15, 'comparison_time': 0.05},  # Mismatch without error_details
            {'test_number': 3, 'passed': False, 'error_details': 'Generator failed', 'generator_time': 0, 'test_time': 0, 'correct_time': 0, 'comparison_time': 0},
            {'test_number': 4, 'passed': False, 'error_details': 'Timeout', 'generator_time': 0, 'test_time': 0, 'correct_time': 0, 'comparison_time': 0}
        ]
    ...
    def test_create_test_result_calculates_execution_times(self, temp_workspace, comparator_files, mock_compiler, mock_database):
        """Should calculate average execution times."""
        comparator = Comparator(str(temp_workspace), files=comparator_files)
        comparator.test_count = 2  # Set test_count for analysis
        
        test_results = [
            {'test_number': 1, 'passed': True, 'generator_time': 0.1, 'test_time': 0.3, 'correct_time': 0.2, 'comparison_time': 0.1},
            {'test_number': 2, 'passed': True, 'generator_time': 0.2, 'test_time': 0.4, 'correct_time': 0.3, 'comparison_time': 0.2}
        ]
    ...
    def test_create_test_result_includes_failed_tests(self, temp_workspace, comparator_files, mock_compiler, mock_database):
        """Should include details of failed tests."""
        comparator = Comparator(str(temp_workspace), files=comparator_files)
        
        test_results = [
            {'test_number': 1, 'passed': True, 'generator_time': 0.1, 'test_time': 0.2, 'correct_time': 0.15, 'comparison_time': 0.05},
            {'test_number': 2, 'passed': False, 'error_details': 'Timeout', 'generator_time': 0, 'test_time': 0, 'correct_time': 0, 'comparison_time': 0}
        ]
    ...
    def test_create_test_result_creates_files_snapshot(self, temp_workspace, comparator_files, mock_compiler, mock_database):
...
class TestComparatorPublicAPI:
    ...
    def test_run_stress_test_calls_base_run_tests(self, temp_workspace, comparator_files, mock_compiler, mock_database):
    ...
    def test_run_stress_test_with_default_max_workers(self, temp_workspace, comparator_files, mock_compiler, mock_database):
    ...
    def test_run_comparison_test_calls_base_run_tests(self, temp_workspace, comparator_files, mock_compiler, mock_database):
        """Should call BaseRunner.run_tests with correct parameters."""
        comparator = Comparator(str(temp_workspace), files=comparator_files)
    ...
    def test_run_comparison_test_modern_api(self, temp_workspace, comparator_files, mock_compiler, mock_database):
    ...
    def test_backward_compatibility_with_stress_test(self, temp_workspace, comparator_files, mock_compiler, mock_database):
...
class TestComparatorEdgeCases:
    ...
    def test_create_test_result_with_empty_results(self, temp_workspace, comparator_files, mock_compiler, mock_database):
    ...
    def test_create_test_result_with_all_failures(self, temp_workspace, comparator_files, mock_compiler, mock_database):
        """Should handle all tests failing."""
        comparator = Comparator(str(temp_workspace), files=comparator_files)
        
        test_results = [
            {'test_number': 1, 'passed': False, 'error_details': 'Failed', 'generator_time': 0, 'test_time': 0, 'correct_time': 0, 'comparison_time': 0},
            {'test_number': 2, 'passed': False, 'error_details': 'Failed', 'generator_time': 0, 'test_time': 0, 'correct_time': 0, 'comparison_time': 0}
        ]
