...
class TestBenchmarker:
    ...
    def test_create_test_result_includes_performance_summary(self, benchmarker):
        ...
        # Arrange
        test_results = [
            {'passed': True, 'time_passed': True, 'memory_passed': True, 'execution_time': 0.5, 'memory_used': 100},
            {'passed': False, 'time_passed': False, 'memory_passed': True, 'execution_time': 1.5, 'memory_used': 200, 'error_details': ''},
            {'passed': False, 'time_passed': True, 'memory_passed': False, 'execution_time': 0.8, 'memory_used': 512, 'error_details': ''},
        ]
...
class TestBenchmarkerTestResultAnalysis:
    ...
    def test_create_test_result_calculates_performance_summary(self, tmp_path):
        ...
        test_results = [
            {'passed': True, 'time_passed': True, 'memory_passed': True, 'execution_time': 100, 'memory_used': 50},
            {'passed': False, 'time_passed': False, 'memory_passed': True, 'execution_time': 1500, 'memory_used': 60, 'error_details': 'Time Limit Exceeded'},
            {'passed': False, 'time_passed': True, 'memory_passed': False, 'execution_time': 200, 'memory_used': 300, 'error_details': 'Memory Limit Exceeded'},
            {'passed': False, 'time_passed': True, 'memory_passed': True, 'execution_time': 150, 'memory_used': 70, 'error_details': 'Runtime Error: Segfault'},
            {'passed': False, 'time_passed': True, 'memory_passed': True, 'execution_time': 120, 'memory_used': 55, 'error_details': 'Execution error'},
        ]
    ...
    def test_create_test_result_includes_failed_tests(self, tmp_path):
        ...
        test_results = [
            {'passed': True, 'execution_time': 100, 'memory_used': 50},
            {'passed': False, 'execution_time': 1500, 'memory_used': 60, 'error_details': 'TLE'},
        ]
