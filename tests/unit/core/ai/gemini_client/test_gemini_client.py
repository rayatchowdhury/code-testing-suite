...
from src.app.core.ai.gemini_client.gemini_client import GeminiAI, get_gemini_client, initialize_gemini, is_gemini_available, is_gemini_ready
...
class TestGeminiAIInitialization:
    ...
    @patch.dict('os.environ', {'GEMINI_API_KEY': 'env_key', 'GEMINI_MODEL': 'env_model', 'GEMINI_ENABLED': 'true'})
