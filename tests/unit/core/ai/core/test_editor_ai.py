...
class TestEditorAIInitialization:
    ...
    def test_init_initializes_gemini_when_config_exists(self, mock_init, mock_exists, temp_config_file):
...
class TestAIResponse:
    ...
    @patch('src.app.core.ai.core.editor_ai.is_gemini_available')
    @patch('src.app.core.ai.core.editor_ai.get_gemini_client')
    def test_get_ai_response_empty_response(self, mock_get_client, mock_available, mock_gemini_client):
...
class TestConfiguration:
    ...
    @patch('src.app.core.ai.core.editor_ai.is_gemini_available')
    @patch('src.app.core.ai.core.editor_ai.get_gemini_client')
    def test_get_current_model_name_available(self, mock_get_client, mock_available, mock_gemini_client):
