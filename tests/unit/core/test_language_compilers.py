...
class TestPythonCompiler:
    ...
    def custom_compiler(self):
        ...
        config = {"interpreter": "python3", "flags": ["-u", "-B"]}
...
class TestJavaCompiler:
    ...
    def custom_compiler(self):
        ...
        config = {"compiler": "javac", "runtime": "java", "flags": ["-Xlint:all"]}
...
class TestConfigIntegration:
    ...
    def test_cpp_custom_config(self):
        ...
        config = {"compiler": "clang++", "std_version": "c++20", "optimization": "O3"}
...
class TestCppCompilerAdvanced:
    ...
    def test_compile_creates_no_window_on_windows(
        ...
        # Verify subprocess.run was called and has creationflags
