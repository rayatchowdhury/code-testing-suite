        ...
        try:
            ...
            if reply == QMessageBox.Yes:
                ...
                if stats_before and stats_after:
                    ...
                    QMessageBox.information(self.parent, "Cleanup Complete", "Data cleanup completed")
    ...
    def delete_all_data(self):
        ...
        try:
            ...
            if success:
                ...
                QMessageBox.critical(self.parent, "Deletion Failed", "Failed to delete data. Check console for details.")
