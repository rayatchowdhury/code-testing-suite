...
from ...styles.components.stress_tester import (
    TEST_COUNT_SLIDER_STYLE,
    TEST_COUNT_VALUE_LABEL_STYLE
)
...
class TestCountSlider(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.slider.setStyleSheet(TEST_COUNT_SLIDER_STYLE)
        
        # Value label
        self.value_label = QLabel("10")
        self.value_label.setStyleSheet(TEST_COUNT_VALUE_LABEL_STYLE)
