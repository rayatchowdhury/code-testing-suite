...
from src.app.presentation.shared.design_system.styles.components.syntax_highlighting import (
...
class CPPSyntaxHighlighter(QSyntaxHighlighter):
    def __init__(self, document):
        ...
        self.highlighting_rules.append(
            (
                QRegularExpression(
                    "\\b(string|vector|map|set|queue|stack|list|deque|array|pair|tuple|unique_ptr|shared_ptr|weak_ptr)\\b"
                ),
                std_classes,
            )
        )
        ...
        self.highlighting_rules.append(
            (QRegularExpression("\\b(std|boost)\\b::"), namespace_format)
        )
        ...
        self.highlighting_rules.append(
            (QRegularExpression("\\b[A-Za-z0-9_]+(?=\\s*\\()"), function_format)
        )
        ...
        self.highlighting_rules.append(
            (QRegularExpression("\\bclass\\s+[A-Za-z0-9_]+\\b"), class_format)
        )
        ...
        self.highlighting_rules.append(
            (QRegularExpression("\\b[A-Z_][A-Z0-9_]*\\b"), constant_format)
        )
...
class PythonSyntaxHighlighter(QSyntaxHighlighter):
    def __init__(self, document):
        ...
        self.highlighting_rules.append(
            (QRegularExpression("\\b(" + "|".join(builtins) + ")\\b"), builtin_format)
        )
        ...
        function_format.setForeground(QBrush(QColor(STYLES["function"])))
        self.highlighting_rules.append(
            (QRegularExpression("\\bdef\\s+[A-Za-z0-9_]+(?=\\s*\\()"), function_format)
        )
        ...
        for pattern in string_patterns:
            self.highlighting_rules.append((QRegularExpression(pattern), string_format))
        ...
        number_format.setForeground(QBrush(QColor(STYLES["number"])))
        self.highlighting_rules.append(
            (QRegularExpression("\\b[0-9]+\\.[0-9]+\\b|\\b[0-9]+\\b"), number_format)
        )
...
class JavaSyntaxHighlighter(QSyntaxHighlighter):
    def __init__(self, document):
        ...
        class_format.setFontWeight(75)
        self.highlighting_rules.append(
            (QRegularExpression("\\b[A-Z][A-Za-z0-9_]*\\b"), class_format)
        )
        ...
        function_format.setForeground(QBrush(QColor(STYLES["function"])))
        self.highlighting_rules.append(
            (QRegularExpression("\\b[a-z][A-Za-z0-9_]*(?=\\s*\\()"), function_format)
        )
