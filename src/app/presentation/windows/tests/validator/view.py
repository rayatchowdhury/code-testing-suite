...
from src.app.presentation.shared.components.editor import TestingContentWidget
from src.app.presentation.shared.components.sidebar import Sidebar
from src.app.presentation.shared.components.sidebar import TestCountSlider
...
class ValidatorWindow(TestWindowBase):
    ...
    def __init__(self, parent=None):
        ...
        # Initialize validator_runner attribute
        self.validator_runner = None
    ...
    def _create_status_view(self):
        ...
        from src.app.presentation.shared.components.status_view import StatusView, VALIDATOR_PRESET
