...
from src.app.presentation.shared.components.sidebar import (
    LimitsInputWidget,
    Sidebar,
    TestCountSlider,
)
...
class BenchmarkerWindow(TestWindowBase):
    ...
    def _create_status_view(self):
        ...
        from src.app.presentation.shared.components.status_view import StatusView, BENCHMARKER_PRESET
