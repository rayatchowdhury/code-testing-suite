...
from src.app.presentation.styles.components.sidebar import SIDEBAR_STYLE, SIDEBAR_BUTTON_STYLE
...
from src.app.presentation.styles.components.ai_panel import AI_PANEL_STYLE, CUSTOM_COMMAND_STYLE
