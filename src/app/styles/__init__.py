...
from src.app.styles.components.syntax_highlighting import SYNTAX_HIGHLIGHTING_COLORS
from src.app.styles.components.console_colors import CONSOLE_COLORS
from src.app.styles.components.sidebar_dividers import (
...
from src.app.styles.constants.status_colors import ERROR_COLOR_HEX, STATUS_COLORS, TEST_STATUS_COLORS
from src.app.styles.style import (
    DISPLAY_AREA_STYLE,
    WEBVIEW_STYLE,
    get_tab_style
)
