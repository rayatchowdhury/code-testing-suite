...
def is_flat_workspace_structure(workspace_dir: str) -> bool:
    ...
    source_indicators = [
        'generator.cpp', 'generator.py', 'Generator.java',
        'correct.cpp', 'correct.py', 'Correct.java',
        'test.cpp', 'test.py', 'Test.java',
        'validator.cpp', 'validator.py', 'Validator.java',
    ]
...
def list_workspace_files(workspace_dir: str, test_type: Optional[str] = None) -> Dict[str, List[str]]:
    """
