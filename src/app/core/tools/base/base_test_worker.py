...
class BaseTestWorker(QObject):
    ...
    def __init__(self, workspace_dir: str, executables: Dict[str, str], 
        ...
        logger.debug(f"Initialized BaseTestWorker with {self.max_workers} workers for {test_count} tests")
    ...
    def run_tests(self) -> None:
        ...
        self.progressUpdated.emit(f"Starting {self.test_count} tests with {self.max_workers} workers...")
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        with self._results_lock:
            ...
            stats = {
                ...
                'pass_rate': (passed_tests / len(self.test_results)) * 100 if self.test_results else 0.0
            }
