...
class LanguageDetector:
    ...
    def get_compiler_command(self, language: Language, source_file: str, 
                           output_file: Optional[str] = None,
                           custom_flags: Optional[List[str]] = None) -> List[str]:
        """
    ...
    def get_execution_command(self, language: Language, executable_path: str,
